...
//由protoc生成的头文件，声明了BlobProto，BlobShape等遵循caffe.proto协议的数据结构
...
class Blob {
 public:
  ...
  //Blob更新运算，可简单理解为data与diff的merge过程
  void Update();
  //反序列化函数，从BlobProto中恢复一个Blob对象
  void FromProto(const BlobProto& proto, bool reshape = true);
  //序列化函数，讲内存中的Blob对象保存到BlobProto中
 ...
 protected:
  ...
  // 注意成员变量名都带有后缀_,这样在函数实现中容易区分临时变量和类成员变量
};  // class Blob
